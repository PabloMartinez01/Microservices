...
import com.pablodev.organizationservice.organization.domain.exception.OrganizationIdNotExistException;
...
public class OrganizationFinder {
    ...
    public OrganizationResponse find(FindOrganizationQuery findOrganizationQuery) {
        ...
        return organizationRepository.findById(id)
                ...
                .orElseThrow(() -> new OrganizationIdNotExistException(id.getValue()));
